...
SRCS = babeld.c net.c kernel.c util.c interface.c source.c neighbour.c \
       ...
       rfc6234/sha1.c rfc6234/sha224-256.c rfc6234/sha384-512.c rfc6234/hmac.c rfc6234/usha.c \
       BLAKE2/ref/blake2s-ref.c

OBJS = babeld.o net.o kernel.o util.o interface.o source.o neighbour.o \
       route.o xroute.o message.o resend.o configuration.o local.o \
       disambiguation.o rule.o hmac.o \
       rfc6234/sha1.o rfc6234/sha224-256.o rfc6234/sha384-512.o rfc6234/hmac.o rfc6234/usha.o \
       BLAKE2/ref/blake2s-ref.o
